...
Version  : 19.04.1
Release  : 7
URL      : https://download.kde.org/stable/applications/19.04.1/src/kolourpaint-19.04.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.1/src/kolourpaint-19.04.1.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.1/src/kolourpaint-19.04.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1557450596
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
cp COPYING %{buildroot}/usr/share/package-licenses/kolourpaint/COPYING
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/kolourpaint/COPYING
