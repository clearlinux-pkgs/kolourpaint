...
Source0  : https://download.kde.org/stable/release-service/21.04.0/src/kolourpaint-21.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.0/src/kolourpaint-21.04.0.tar.xz.sig
...
%prep
%setup -q -n kolourpaint-21.04.0
cd %{_builddir}/kolourpaint-21.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619221257
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kolourpaint-21.04.0/COPYING %{buildroot}/usr/share/package-licenses/kolourpaint/16f2f17f30faa850073c3ca39c4fbff4c53c3e71
cp %{_builddir}/kolourpaint-21.04.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kolourpaint/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kolourpaint-21.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kolourpaint/c08668a6ace9b36ba46940609040748161b03a37
pushd clr-build
%make_install
popd
