...
Version  : 22.04.1
Release  : 38
URL      : https://download.kde.org/stable/release-service/22.04.1/src/kolourpaint-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/kolourpaint-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/kolourpaint-22.04.1.tar.xz.sig
...
%prep
%setup -q -n kolourpaint-22.04.1
cd %{_builddir}/kolourpaint-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652643861
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kolourpaint-22.04.1/COPYING %{buildroot}/usr/share/package-licenses/kolourpaint/16f2f17f30faa850073c3ca39c4fbff4c53c3e71
cp %{_builddir}/kolourpaint-22.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kolourpaint/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kolourpaint-22.04.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kolourpaint/c08668a6ace9b36ba46940609040748161b03a37
pushd clr-build
%make_install
popd
