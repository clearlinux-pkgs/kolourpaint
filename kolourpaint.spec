...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/kolourpaint-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/kolourpaint-22.12.0.tar.xz.sig
...
%prep
%setup -q -n kolourpaint-22.12.0
cd %{_builddir}/kolourpaint-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670524066
mkdir -p clr-build
pushd clr-build
