...
Version  : 19.08.1
Release  : 11
URL      : https://download.kde.org/stable/applications/19.08.1/src/kolourpaint-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/kolourpaint-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/kolourpaint-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567707231
mkdir -p clr-build
pushd clr-build
