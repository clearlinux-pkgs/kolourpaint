...
Version  : 23.04.0
Release  : 50
URL      : https://download.kde.org/stable/release-service/23.04.0/src/kolourpaint-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kolourpaint-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kolourpaint-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kolourpaint-23.04.0
cd %{_builddir}/kolourpaint-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682026074
mkdir -p clr-build
pushd clr-build
