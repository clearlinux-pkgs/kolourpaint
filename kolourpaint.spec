...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/kolourpaint-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/kolourpaint-23.04.2.tar.xz.sig
...
%prep
%setup -q -n kolourpaint-23.04.2
cd %{_builddir}/kolourpaint-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686514011
mkdir -p clr-build
pushd clr-build
